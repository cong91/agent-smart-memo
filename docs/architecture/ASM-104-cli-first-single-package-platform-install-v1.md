...
> **Scope update (2026-04-09):** Active installer/runtime scope is OpenClaw plus optional OpenCode integration. This note is retained as architecture history.
...
- các runtime/platform như `openclaw`, `opencode` là **installation targets** do CLI điều phối
...
- OpenClaw/OpenCode không có package public tách riêng ở bề mặt user-facing
...
Các artifact kiểu local/plugin-only cho debug/smoke
...
- tạo package public mới cho OpenCode
